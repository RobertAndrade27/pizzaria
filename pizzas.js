let pizzaJson = [
    {id:1, name:'Mussarela', img:'images/pizza.png', price:18.00, sizes:['100g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
    ...
    {id:8, name:'Refrigerante', img:'images/coca.png', price:11.90, sizes:['Lata350ml', 'Pet1l', 'Pet2l'], description:'Coquinha geladinha huuum!'}
];